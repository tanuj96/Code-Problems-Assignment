...
data.forEach((record) => {
    ...
    let currColumn = document.createElement('td');
    let rateColumn = document.createElement('td');

    dateColumn.textContent = record.fields.date;
    currColumn.textContent = record.fields.currency;
    rateColumn.textContent = record.fields.rate.toFixed(2);

    row.appendChild(dateColumn);
    row.appendChild(currColumn);
    row.appendChild(rateColumn);
